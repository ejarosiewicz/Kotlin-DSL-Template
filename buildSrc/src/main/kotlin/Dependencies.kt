object Dependencies {
    ...
    object Compile {
        const val kotlinStdLibJdk = "org.jetbrains.kotlin:kotlin-stdlib-jdk7:${Versions.kotlinStdLibJdk}"
    }

    object Versions {
        const val kotlinStdLib = "1.2.61"
        const val jUnit = "4.12"
        const val espresso = "3.0.2"
        const val runner = "1.0.2"
        const val kotlinStdLibJdk = "1.2.61"
    }
}